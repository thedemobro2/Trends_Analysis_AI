...
file_path = '/mnt/data/goodreads_library_export.csv'
...
results = {
    ...
    "Most Read Authors": most_read_authors.to_dict(),
    "Average Rating by Author": average_rating_by_author.to_dict(),
    "Books Read Over Time": books_read_over_time.to_dict(),
    "Pages Read Over Time": pages_read_over_time.to_dict(),
